...
### Colaberry AI Project Defaults

**All colaberry.ai work goes into the existing Dev Team project.** Do NOT create new projects.

| Setting | Value |
|---------|-------|
| Account | Colaberry Inc (`3945211`) |
| Project | Dev Team (`6593808`) |
| Default Todolist | colaberry.ai tasks (`9400838252`) |
| Project URL | https://3.basecamp.com/3945211/buckets/6593808/todolists/9400838252 |

**When creating todos for colaberry.ai**, always use:
```bash
basecamp todos create "Task description" -p 6593808 -l 9400838252 --description "Details"
```

**When creating sprint todolists** (via `/prd`), create them inside the Dev Team project:
```bash
basecamp todolists create "Sprint vN: [Title] — P0 (Must Have)" -p 6593808
```

**When posting messages**, post to Dev Team:
```bash
basecamp messages create "Subject" "Body" -p 6593808
```
