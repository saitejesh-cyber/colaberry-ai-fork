...
export default function EnterprisePageHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-white dark:bg-[#09090B]">
      <div className={`relative z-10 grid gap-6 px-6 py-10 sm:px-8 sm:py-12 lg:items-start lg:px-10 lg:py-16${image ? " lg:grid-cols-[1.08fr_0.92fr]" : ""}`}>
        <div className="flex flex-col gap-4">
          ...
          <h1 className="rise-in rise-delay-2 mt-2 font-sans text-display-sm font-bold text-zinc-900 dark:text-zinc-50 sm:text-display-md lg:text-display-lg">
            {title}
          </h1>
